...
public class clienteTagEvento {
    ...
    public <T> T encontrarTagEv_XML(Class<T> responseType, String ev) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("tagEventoEv/{0}", new Object[]{ev}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T encontrarTagEv_JSON(Class<T> responseType, String ev) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("tagEventoEv/{0}", new Object[]{ev}));
    ...
    public <T> T encontrarTagEvPorTag_XML(Class<T> responseType, String tag) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("tagEventoTag/{0}", new Object[]{tag}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T encontrarTagEvPorTag_JSON(Class<T> responseType, String tag) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("tagEventoTag/{0}", new Object[]{tag}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
